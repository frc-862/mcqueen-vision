 ...
 */
cv::Mat* InfiniteRecharge::GetHsvThresholdOutput(){
 ...
 */
cv::Mat* InfiniteRecharge::GetCvDilateOutput(){
 ...
 */
cv::Mat* InfiniteRecharge::GetCvErodeOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* InfiniteRecharge::GetFindContoursOutput(){
...
std::vector<std::vector<cv::Point> >* InfiniteRecharge::GetFilterContoursOutput(){
	 ...
	 * @param output The image in which to store the output.
	 */
	void InfiniteRecharge::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void InfiniteRecharge::cvDilate(cv::Mat &src, cv::Mat &kernel, cv::Point &anchor, double iterations, int borderType, cv::Scalar &borderValue, cv::Mat &dst) {
	 ...
	 * @param dst Output Image.
	 */
	void InfiniteRecharge::cvErode(cv::Mat &src, cv::Mat &kernel, cv::Point &anchor, double iterations, int borderType, cv::Scalar &borderValue, cv::Mat &dst) {
	 ...
	 */
	void InfiniteRecharge::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void InfiniteRecharge::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
